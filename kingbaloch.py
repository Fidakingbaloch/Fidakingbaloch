...
print  """
\033[1;97m************************************************
\033[1;95m~ IM NOT RESPONSIBLE FOR ANY MISS USE MR king baloch ~
\033[1;97m************************************************

\033[1;95m┏━━━━━°�•°�°•━━━━━┓
\033[1;93m☆ Ƙíղց😎вalocн☆
\033[1;95m┗━━━━━°�•°�°•━━━━━┛
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:king_baloch
	    time.sleep(1)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://youtu.be/XVipz5n4R9Q')
    else:
...
def menu():
	...
	print "\033[1;36;40m      ╚═════════════════════════════════╝"
	print "    \033[1;32;40m[Type1] \033[1;33;40m‹•.•›Start🕷️Hacking"	
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mking_baloch\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mking_baloch\033[1;95m•◈•══════••◈•"
		try:
	...
	jalan('           \033[1;93mking start cloning Wait Whatsapp👉03041965787...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mKing_baloch\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By Anees_Jerry--•◈•---»" #Dev:baloch
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 kingbaloch.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....Anees Creations Whatsapp👉03041965787....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m baloch"""
